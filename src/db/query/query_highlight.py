...
def get_student_highlight(db: Optional[Database], params: Dict[str, Any]):
    ...
    query = f"""
        SELECT highlight_1_title, highlight_1_detail, highlight_2_title, highlight_2_detail, highlight_3_title, highlight_3_detail
